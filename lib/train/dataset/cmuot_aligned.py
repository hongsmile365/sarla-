...
class CMUOTAligned(BaseVideoDataset):
    """ CMUOTAligned dataset.
    ...
    def __init__(self, root=None, image_loader=jpeg4py_loader, split=None, data_fraction=None):
        ...
        """
        root = env_settings().uavcross_dir if root is None else root
        super().__init__('CMUOTAligned', root, image_loader)
