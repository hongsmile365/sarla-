...
"""ostrack"""
trackers.extend(trackerlist(name='sarla', parameter_name='only_cur_feat_ep50_2', dataset_name=dataset_name,
                            run_ids=50, display_name='DTTrack'))
...
print_results_per_video(trackers, dataset, dataset_name+'99', merge_results=True, plot_types=('success', 'prec', 'norm_prec'),
                        per_video=True, force_evaluation=True)
print_results(trackers, dataset, dataset_name + '6', merge_results=True, plot_types=('success', 'norm_prec', 'prec'))
