...
class VisionTransformerCE(VisionTransformer):
    ...
    def forward(self, z, x, last_x,ce_template_mask=None, ce_keep_rate=None,
                tnc_keep_rate=None,
                return_last_attn=False):

        x, aux_dict = self.forward_features(z, x, last_x, ce_template_mask=ce_template_mask, ce_keep_rate=ce_keep_rate,)
