...
dataset_dict = dict(
    ...
    lasot_extension_subset=DatasetInfo(module=pt % "lasotextensionsubset", class_name="LaSOTExtensionSubsetDataset",
                                       kwargs=dict()),
    cmuot_aligned=DatasetInfo(module=pt % "cmuot_aligned", class_name="CMUOTAlignedDataset", kwargs=dict()),
    cmuot=DatasetInfo(module=pt % "cmuot", class_name="CMUOTDataset", kwargs=dict()),
    rgbnir=DatasetInfo(module=pt % "rgbnir", class_name="RGBNIRDataset", kwargs=dict()),
)
